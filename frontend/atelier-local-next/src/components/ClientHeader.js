    ...
    <header className="bg-blue text-gold shadow-md flex flex-col md:flex-row justify-between items-center">
      ...
      <nav className="flex flex-col md:flex-row w-full md:w-auto text-sm text-center">
        ...
        <Link
          ...
          className="bg-gold text-blue flex-auto flex items-center justify-center px-2 hover:underline pb-2 md:pb-0"
        >
        ...
        <Link
          href="/logout"
          className="bg-gold text-blue flex-auto flex items-center justify-center pr-2 py-1 hover:underline"
        >
          Déconnexion
        </Link>
      </nav>
